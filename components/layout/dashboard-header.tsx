      ...
      <div className="ml-auto flex items-center gap-2">
        <DropdownMenu>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -right-1 top-5 flex size-4 items-center justify-center rounded-full bg-primary text-[10px] font-semibold text-primary-foreground ring-2 ring-background">
                {unreadCount}
              </span>
            )}
          ...
          <DropdownMenuContent align="end" sideOffset={8} className="w-80 p-0">
           ...
           <Link href={"/dashboard/chat"}>
             <DropdownMenuItem  className="cursor-pointer justify-center py-2.5 text-xs font-medium text-primary">
               {"Barchasini ko'rish"}
             </DropdownMenuItem>
           </Link>
          </DropdownMenuContent>
